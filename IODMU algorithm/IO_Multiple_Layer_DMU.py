...
if __name__ == '__main__':
    mat11before = np.triu(np.random.uniform(5, 120, size=(26, 26)))
    mat22before = np.random.uniform(5, 120, size=(56, 56))
    mat12before = np.random.uniform(5, 120, size=(26, 56))
    mat21before = np.random.uniform(5, 120, size=(56, 26))
    block_matrix_before = np.array([[mat11before, mat12before],
                                    [mat21before, mat22before]])

    mat11after = np.triu(np.random.uniform(5, 120, size=(26, 26)))
    mat22after = np.random.uniform(5, 120, size=(56, 56))
    mat12after = np.random.uniform(5, 120, size=(26, 56))
    mat21after = np.random.uniform(5, 120, size=(56, 26))
    block_matrix_after = np.array([[mat11after, mat12after],
                                   [mat21after, mat22after]])
    print(block_matrix_before)
    print(block_matrix_after)
    IO = IOMultipleLayerDMU(block_matrix_before,block_matrix_after,0.000000000001)
    print(IO.IOMLDMU())